  ...
  return (
    <div className='w-full h-screen bg-black text-white'>
        ...
        <div className='absolute z-10 top-[10%] md:top-[15%] left-3 pr-3 sm:pr-0 sm:left-8'>
            ...
            <Timer />
            <p className="text-center 2xl:text-2xl mt-4 md:mt-10 text-white">Psyche is supposed to have <br className='hidden md:block'/> limitless deposits of Etherium <br className='hidden md:block'/>in addition to metal</p>
        </div>
